package org.buzzar.app.fragments;
...
import org.buzzar.app.logic.cache.CacheEntity;
import org.buzzar.app.logic.cache.CachingHandler;
import org.buzzar.app.logic.Constants;
import org.buzzar.app.logic.Helper;
import org.buzzar.app.logic.JsonProvider;
import org.buzzar.app.logic.LocationHandler;
import org.buzzar.app.logic.MeteorBroadcastReceiver;
import org.buzzar.app.logic.objects.response.GetPostsResponse;
import org.buzzar.app.logic.objects.Photo;
import org.buzzar.app.logic.objects.Post;
import org.buzzar.app.activities.PostDetailsActivity;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (viewType == VIEW_TYPE_POST) {
                ...
                if (currentLocation != null) {
                    org.buzzar.app.logic.objects.Location location = post.getLocation();
                    if (location != null) {
                ...
                if (post.isLive()) {
                    if (org.buzzar.app.logic.objects.Location.LOCATION_TYPE_DYNAMIC.equals(post.getPostType())) {
